...
class _EditExpensePageState extends State<EditExpensePage> {
  ...
  void initState() {
    super.initState();
    final builtInCategories = ['transpo', 'food', 'school', 'groceries','bills'];
    ...
    if(builtInCategories.contains(widget.expense.category.toLowerCase())){
      category=widget.expense.category.toLowerCase();
      customCategory = '';
    } else {
      category = 'custom';
                            ...
                            if (category == 'custom')...[
                               Padding(
                                ...
                                child: _buildTextInput(
                                  ...
                                  validator: (v) {
                                    if (category == 'custom' && (v == null || v.trim().isEmpty)) {
  ...
  Widget _buildDropdown() {
    final validCategories = ['transpo', 'food', 'school', 'groceries','bills', 'custom',];
